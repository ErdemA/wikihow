...
class AdminClearRatings extends UnlistedSpecialPage {
	function __construct() {
		UnlistedSpecialPage::UnlistedSpecialPage('AdminClearRatings');
	}
	...
	function execute() {
		...
		if ($wgRequest->wasPosted()) {
			...
			$html .= $this->generateResults($pageData, $failedPages);
	...
	private function generateResults($pageData, $failedPages) {
