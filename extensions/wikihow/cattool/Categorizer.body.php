...
class Categorizer extends UnlistedSpecialPage {
	...
	function display(&$t) {
		...
		if (!$this->editPage) {
			$wgOut->addHTML(HtmlSnips::makeUrlTags('css', array('categorizer.css'), 'extensions/wikihow/cattool', false));
			$wgOut->addScript(HtmlSnips::makeUrlTags('js', array('categorizer.js'), 'extensions/wikihow/cattool', false));
		}
		...
		$wgOut->setPageTitle(wfMsg('cat_app_name'));
	}
