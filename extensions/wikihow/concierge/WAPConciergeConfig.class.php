...
class WAPConciergeConfig implements WAPConfig {
	...
	public function getMaintenanceStandardEmailList() {
		...
		return 'thom@wikihow.com,wikihowphotos@gmail.com,allyson@wikihow.com,elizabeth@wikihow.com,jordan@wikihow.com,chris@wikihow.com,daniel@wikihow.com';
	}

	public function getMaintenanceCompletedEmailList() {
		//return 'jordan@wikihow.com';
		return 'thom@wikihow.com,wikihowphotos@gmail.com,allyson@wikihow.com,elizabeth@wikihow.com,john@wikihow.com,jordan@wikihow.com,daniel@wikihow.com';
	}

	public function getDefaultUserName() {
		throw new Exception('no default user name defined in WAPConciergeConfie');
	}
