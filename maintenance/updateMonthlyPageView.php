...
if (!IS_PROD_EN_SITE) {
	...
	$dbr = new Database(WH_DATABASE_BACKUP, WH_DATABASE_MAINTENANCE_USER, WH_DATABASE_MAINTENANCE_PASSWORD, "wiki_log");
...
foreach($articles as $articleData) {
	...
	$res = $dbr->select('page_views', array('*'), array('page' => $titleText, "(domain = 'www.wikihow.com' OR domain = 'm.wikihow.com')", "day >= '{$monthAgoString}'"));
