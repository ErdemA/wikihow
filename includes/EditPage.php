...
class EditPage {
	...
	function showEditForm( $formCallback=null ) {
		...
		$cancel = $sk->makeKnownLink( $wgTitle->getPrefixedText(),
				wfMsgExt('cancel', array('parseinline')),'','','','class="button secondary" id="edit_cancel_btn"' );
...
");
	...
	function getEditToolbar() {
		...
		$toolbar = "<div id='toolbar' style='float: left; margin-bottom:3px;'>\n";
		$toolbar.="<script type='$wgJsMimeType'>\n/*<![CDATA[*/\n";

		foreach($toolarray as $tool) {
			// XXCHANGED -- use CDN
			$params = array(
				$image = wfGetPad($wgStylePath.'/owl/images/'.$tool['image']),
		...
		$toolbar.="\n</div>";
		$toolbar .= PopBox::getToolbarButton() . ($wgLanguadeCode == 'en' ? "<div style='float:left;'><input id='fixcaps_button' type='image' src='/skins/WikiHow/images/fixcaps.png' accesskey='o' onclick='javascript:fixcaps(document.editform.wpTextbox1)'/></div>\n" : "");
