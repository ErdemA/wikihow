...
function wfSpecialWatchlist( $par ) {
	...
	$wgOut->addHTML( "<div class='watchlistoptions'>" );
	...
	$wgOut->setPageTitle( wfMsg( 'watchlist' ) . " " .  wfMsgExt( 'watchlistfor_owl', 'parseinline', $wgUser->getName() ) );
	
	$sub .= WatchlistEditor::buildTools( $wgUser->getSkin() );
	$wgOut->addHTML( $sub );
  ...
  # Toggle watchlist content (all recent edits or just the latest)
	...
	if ( $wgEnotifWatchlist && $wgShowUpdatedMarker ) {
		$wgOut->addHTML( '<form action="' .
			...
			'" method="post"><input class="button primary" type="submit" name="dummy" value="' .
	...
	$form .= Xml::submitButton( wfMsg( 'allpagessubmit' ), array('class' => 'button primary small') ) . '</p>';
